...
import com.davkovania.system.silvia.systemdavkovania.Fragments.Info;
import com.davkovania.system.silvia.systemdavkovania.Fragments.NotActive;
import com.davkovania.system.silvia.systemdavkovania.Fragments.Notifications;
...
//        setSupportActionBar(toolbar);
        ...
        nameOfMedicine = getIntent().getStringExtra("name");

//        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
//        fab.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                Intent intentAdd = new Intent(MainActivity.this, NewMedicineActivity.class);
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    ...
                    break;
                case 1:
                    bundle.putSerializable("name", nameOfMedicine);
                    fragment = new Info();
